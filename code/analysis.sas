...
ods region column=4 row=2; %plot(state=&state., cod=Liver Disease, name=Liver Disease, xlabel=display=(nolabel novalues),ylabel=display=(nolabel));
...
ods region column=2 row=3; %plot(state=&state., cod=Influenza and Pneumonia, name=Influenza and Pneumonia, xlabel=display=(nolabel novalues),ylabel=display=(nolabel));
ods region column=3 row=3; %plot(state=&state., cod=Unknown Disease, name=Unknown Disease, xlabel=display=(nolabel novalues),ylabel=display=(nolabel));
ods region column=4 row=3; %plot(state=&state., cod=HIV, name=HIV, xlabel=display=(nolabel novalues),ylabel=display=(nolabel));
